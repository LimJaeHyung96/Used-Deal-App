...
import com.example.fastcampus_14.databinding.ItemChatBinding
...
class ChatItemAdapter : ListAdapter<ChatItem, ChatItemAdapter.ChatItemViewHolder>(diffUtil) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChatItemViewHolder {
        return ChatItemViewHolder(ItemChatBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
